...
interface PageDocumentData {
  /**
   * Testing title field in *Page*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: page.titleTest
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  titleTest: prismic.TitleField;
...
/**
 * Item in *Bento → Default → Primary → Bento Text*
 */
export interface BentoSliceDefaultPrimaryBentoTextItem {
  /**
   * Title field in *Bento → Default → Primary → Bento Text*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_text[].title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;

  /**
   * Body field in *Bento → Default → Primary → Bento Text*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_text[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Bento Text*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_text[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Bento Text*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.bento_text[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Bento Text field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_text[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  bento_text: prismic.GroupField<
    Simplify<BentoSliceDefaultPrimaryBentoTextItem>
  >;
}
...
/**
 * Item in *Integration → Default → Primary → Icons*
 */
export interface IntegrationSliceDefaultPrimaryIconsItem {
  /**
   * Icon field in *Integration → Default → Primary → Icons*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
...
export interface IntegrationSliceDefaultPrimary {
  ...
  /**
   * Icons field in *Integration → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryBentoTextItem,
